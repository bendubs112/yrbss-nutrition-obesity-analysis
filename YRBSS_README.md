...
```
├── Full_Do_File_-_Nutrition_-_Copy.do                                      # Main analysis script
...
**Don't have Stata?** You can review the complete analysis output in the included log file (`Full_Data_Log.txt`), which contains all statistical results, summary tables, and test outputs.
